...
#define NODE_MAIN_LOGGER_NAME "vk_ros2_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvk_ros2_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vkc::VkRos2Driver>";
